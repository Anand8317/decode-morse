...
**Decode Morse**  is a method used in translate the encoded text characters as standardized sequences of two different signal durations, called dots and dashes,.
...
- Method to decode a Morse code character, and return the corresponding character in uppercase (e.g. decode_char(".-") returns "A").
- method to decode an entire word in Morse code, and return the string representation. Every character in a word will be separated by a single space (e.g. decode_word("-- -.--") returns "MY").
